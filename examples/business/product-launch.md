...
**Outcome:** A SaaS notification system built in 2.5 days. 5 checkpoints caught a security gap in the plan. Read rate hit 67% — above the 60% industry bar.
...
Four parallel research tracks investigate:

- **Track 1:** Notification architecture patterns (WebSocket for real-time, SSE for one-way, polling as fallback)
- **Track 2:** Service comparison — Novu (open source, self-host), Knock (managed, $0.01/notification), OneSignal (push-focused)
- **Track 3:** UX research — categorized notifications (urgent/info/marketing), user preference controls, quiet hours
- **Track 4:** Scale analysis — 5K DAU × 3 events/day = 15K notifications/day. Any service handles this.
...
*This example shows Standard mode for a feature build — 11 phases, 5 checkpoints, research-informed decisions.*
